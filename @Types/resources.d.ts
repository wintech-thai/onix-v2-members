interface Resources {
  ...
  "point": {
    ...
    "earned": "Earned",
    "manageYourPoint": "Manage your points and rewards",
    "next": "Next",
    "noTransactionsYet": "No transactions yet",
    "of": "of",
    "page": "Page",
    "pointTransactionHistory": "Point Transaction History",
    "points": "points",
  ...
  "profile": {
    ...
    "editProfile": {
      ...
      "form": {
        ...
        "validation": {
          ...
          "phoneNumberInvalid": "Incorrect phone format (must be E.164, e.g. +66812345678)",
    ...
    "footer": {
      "copyright": "© {{year}} Dev Hub Co., Ltd. All rights reserved."
    },
    "label": {
